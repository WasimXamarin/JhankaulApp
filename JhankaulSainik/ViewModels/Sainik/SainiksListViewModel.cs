...
{
    public class SainiksListViewModel : BaseViewModel
    {
        public SainiksListViewModel()
        {
            SainikDataMethod();
        ...
        private async void SainikClicked(SainikModel sainikModelTapped)
        {
            try
            {
                if(sainikModelTapped != null)
                {
                    ...
                    //await Shell.Current.GoToAsync($"{nameof(SainiksListPage)}/{nameof(SainiksListDetailsPage)}?content={jsonString}");
                    await Shell.Current.GoToAsync($"///SainiksListPage/SainiksListDetailsPage?content={jsonString}");
